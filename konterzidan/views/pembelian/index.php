...
<html lang="en">
  <head>
    ...
    <title>Konter Zidan - Pembelian</title>    
    ...
    <div class="container">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col col-sm-3">
                            <a href="http://localhost:8080/konterzidan/views/pembelian/add.php" class="btn btn-success btn-sm float-end">Add</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        function showAll() {
            $.ajax({
                ...
                url:"http://localhost:8080/konterzidan/api/pembelian/read.php",
                ...
                // console.log(response);
                    ...
                    for (var i = 0; i < json.length; i++) {
                        var sub_array = {
                            'idtrx' : json[i].idtrx,
                            'nama_supp' : json[i].nama_supp,
                            'tgl_pembelian' : json[i].tgl_pembelian,
                            'kasir' : json[i].kasir,
        ...
        function showOne(id) {
            ...
            $.ajax({
                ...
                contentType: "application/json",
                url:
                "http://localhost:8080/konterzidan/api/pembelian/read.php?id="+id,
                success: function(response) {
                    $('#id').val(response.id);
                    $('#idtrx').val(response.idtrx);
                    $('#nama_supp').val(response.nama_supp);
                    $('#tgl_pembelian').val(response.tgl_pembelian).change();
        ...
        function deleteOne(idtrx) {
            ...
            $.ajax({
                url:"http://localhost:8080/konterzidan/api/pembelian/delete.php",
                method:"DELETE",
