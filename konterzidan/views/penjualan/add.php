...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">PENJUALAN KONTER ZIDAN</a>
    ...
    <div class="    ">        
        ...
        <div class="container px-4">
            <form class="row g-1" id="sample_form">
                ...
                <div class="col-md-6">
                    <label for="nama_cust" class="form-label">Customer</label>
                    <input type="text" class="form-control" id="nama_cust" placeholder="John Doe">
                </div>
                <div class="col-md-6">
            ...
            $('#sample_form').on('submit', function(event){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        window.location.href = 'http://localhost:8080/konterzidan/views/penjualan/index.php';
                    },
                    error: function(err) {
                        console.log(err);   
